    ...
    className="w-full h-auto  cursor-pointer" href={`${docUrl}`}>{docUrl}</a>
      ...
      <div className="modal">
        <div className="modal-content">
          ...
          <Image  src={profileUrl} alt="Modal image" width="400" height="400"
    ...
    <div className="modal-overlay">
      <div className="modal-content">
        ...
        {docPassportUrl.endsWith('.pdf') ? (
          ...
          >
            <Page wrap pageNumber={1} scale={0.5} renderTextLayer={false} renderAnnotationLayer={false} renderInteractiveForms={false} />
          </Document>
          </div>
        ) : (
             <Image src={docPassportUrl} alt="Modal image" width="600" height="600"
    className="w-full h-auto" />
        )}
      </div>
    </div>
    ...
    <div className="modal-overlay">
      <div className="modal-content">
        ...
        {docRecommandationLetterUrl.endsWith('.pdf') ? (
          ...
          >
            <Page wrap pageNumber={1} scale={1} renderTextLayer={false} renderAnnotationLayer={false} renderInteractiveForms={false} />
          </Document>
          </div>
        ) : (
             <Image src={docRecommandationLetterUrl} alt="Modal image" width="600" height="600"
        className="w-full h-auto" />
        )}
      </div>
    </div>
        ...
        {docProofOfM1Url.endsWith('.pdf') ? (
          ...
          >
            <Page wrap pageNumber={1} scale={0.5} renderTextLayer={false} renderAnnotationLayer={false} renderInteractiveForms={false} />
             ...
             <Image src={docProofOfM1Url} alt="Modal image" width="600" height="600"
    className="w-full h-auto" />
        )}
      </div>
    </div>
        ...
        {docBACCertificateUrl.endsWith('.pdf') ? (
          ...
          >
            <Page wrap pageNumber={1} scale={0.5} renderTextLayer={false} renderAnnotationLayer={false} renderInteractiveForms={false} />
               ...
               <Image src={docBACCertificateUrl} alt="Modal image" width="600" height="600"
    className="w-full h-auto" />
        )}
      </div>
    </div>
        ...
        {docTranscriptUrl.endsWith('.pdf') ? (
          ...
          >
            <Page wrap pageNumber={1} scale={0.5} renderTextLayer={false} renderAnnotationLayer={false} renderInteractiveForms={false} />
             ...
             <Image src={docTranscriptUrl} alt="Modal image" width="600" height="600"
    className="w-full h-auto" />
        )}
      </div>
    </div>
      ...
      <div className="modal-content">
        ...
        {docResearchUrl.endsWith('.pdf') ? (
          ...
          >
           ...
           <Image src={docResearchUrl} alt="Modal image" width="600" height="600"
    className="w-full h-auto" />
        )}
      </div>
    </div>
