...
async function handler (req , res){
    try {
        ...
        const existCourse = await courseExist(connection , course_id ,teacher_id ,major_id)
        const existCourseC = await courseExist(connection , course_id ,teacher_idC ,major_id)
        ...
        if(existCourse){
            const response = await updateAssign(connection , teacher_idC , course_id , teacher_id)
