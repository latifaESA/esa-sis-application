...
export default function CalendarView() {
  ...
  const handleButtonClick = (majorId , userid , promotion) => {
    router.push(`/student/calenderById?majorId=${majorId}&userid=${userid}&promotion=${promotion}`);
  };
              ...
              <>
                {isMultiMajor.map((item, index) => (
                  <div className="flex font-bold text-xl" key={index}>
                    <button
                      ...
                      type="button"
                      onClick={() => handleButtonClick(item.majorid, item.userid , item.promotion)}
                    >
                ...
                <div className="flex font-bold text-xl">
                  <button
                    ...
                    type="button"
                    onClick={() => handleButtonClick(session.user?.majorid, session.user?.userid ,session.user?.promotion)}
                  >
