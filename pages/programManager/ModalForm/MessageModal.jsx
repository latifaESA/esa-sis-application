            ...
            <div className="relative w-50 my-6 mx-auto max-w-3xl">
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                <div className="relative p-6 flex-auto">
                  ...
                  <BsExclamationTriangle className="h-16 w-16 text-yellow-500 item-center mb-3" /> {data.message}
                      
                  </p></>:<></>}
                  {data.code === 201? <><p className="text-gray-700 mb-10 font-bold p-2 grid place-items-center gap-4">
                    <BsCheckCircleFill className="h-16 w-16 text-gray-700 item-center mb-3 "/>
                      {data.message}
                  </p></>:<></>}
