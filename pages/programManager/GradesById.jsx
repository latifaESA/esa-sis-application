...
import DownloadGradeMultiMajor from './downloadGradeMultiMajor';
import UploadGradesByMajor from './uploadGradesByMajor';
export default function GradesById() {
    ...
    let secondMajorWord = getFirstWordAfterHyphen(session?.user.majorName);
...
GradesById.auth = true;
GradesById.adminOnly = true;
