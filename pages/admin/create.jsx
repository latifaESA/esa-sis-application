    ...
    <>
     ...
     {session?.user.role === '0' ? ( <>
      ...
      <form >
        ...
        <label>
            Status:
            <select className="ml-9 w-40" onChange={(e) => setStatus(e.target.value)}>
         ...
         <label className=''>
            Role:
            <select className="ml-9 w-40 max-[840px]:ml-[50px]" onChange={(e) => setRole(e.target.value)}>
        ...
        {role == '3' ? (<AccountsAssistance assistance={assistance} setAssistance={setAssistance} />)
        :
