...
export const studentInfoSchema_MBA_en = yup.object().shape({
...
export const studentInfoSchema_MBA_fr = yup.object().shape({
...
export const studentSaveInfoSchema_MBA_en = yup.object().shape({
...
export const studentSaveInfoSchema_MBA_fr = yup.object().shape({
  personalinfo_title: yup.string().trim(),
  fname: yup.string().trim(),
  personalinfo_fathername: yup.string().trim(),
  lname: yup.string().trim(),
