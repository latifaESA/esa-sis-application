...
export const studentInfoSchema_DBA_en = yup.object().shape({
  ...
  otherPayment: yup
    ...
    .when('payment', {
      is: (name) => name === 'Other',
      then: yup.string().trim().required('Enter Other Payment Method'),
    }),
});

export const studentInfoSchema_DBA_fr = yup.object().shape({
...
export const studentSaveInfoSchema_DBA_en = yup.object().shape({
...
export const studentSaveInfoSchema_DBA_fr = yup.object().shape({
  personalinfo_title: yup.string().trim(),
  fname: yup.string().trim(),
  personalinfo_fathername: yup.string().trim(),
  lname: yup.string().trim(),
