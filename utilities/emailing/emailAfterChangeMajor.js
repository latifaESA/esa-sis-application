 ...
 * File: utilities\emailing\EmailAfterChangMajor.js
...
async function EmailAfterChangMajor({ lname, fname, newID, email, defaultpassword,oldmajor,newmajor }) {
  ...
  const emailBody =
    ...
    `<p>Your Major has been Update <br> From:<span style="font-weight: bold">${oldmajor}</span> <br> To:<span style="font-weight: bold">${newmajor}</span>.</p>` +
    `<p>Your New ID is: <span style="font-weight: bold">${newID}</span>.</p>` +
    `<br>` +
...
export default EmailAfterChangMajor;
